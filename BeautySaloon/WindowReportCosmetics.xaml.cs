...
namespace BeautySaloon
{
    ...
    public partial class WindowReportCosmetics : Window
    {
        ...
        public WindowReportCosmetics(ReportLogic logic)
        {
            InitializeComponent();
            this.logic = logic;
        }
        ...
        private void buttonToPdf_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                NetworkCredential basicauthenticationinfo = new NetworkCredential("ksenia.savkina2001@gmail.com", "Здесь надо ввести пароль");
