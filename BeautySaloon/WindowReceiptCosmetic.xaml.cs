...
{
    /// <summary>
    /// Логика взаимодействия для WindowReceiptCosmetic.xaml
    /// </summary>
    public partial class WindowReceiptCosmetic : Window
    {
        [Dependency]
        ...
        public WindowReceiptCosmetic(CosmeticLogic logic)
        {
            InitializeComponent();
            this.logic = logic;
        }

        private void WindowReceiptCosmetic_Loaded(object sender, RoutedEventArgs e)
        {
